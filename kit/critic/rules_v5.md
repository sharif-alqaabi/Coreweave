...
## confound
The signal comes from a minority of samples (carriers below half of the group) or from samples listed in `sample_flags`. This applies even if mean counts are high. (fixes: lead_054, lead_013)
...
## already_known
A claim is already_known if it restates expected biology without leveraging enrichment to propose a novel, testable mechanism. This includes claims about high-expression genes showing differential expression (lead_048) or textbook pathway enrichments like muscle structure (GO:0061061), I band (GO:0031674), or sarcomere (GO:0030017) without specific downstream assays (fixes: lead_048, lead_041, lead_038, lead_037).
...
## no_mechanism
The numbers hold but the claim offers no biological mechanism *and* the gene lacks annotated function (e.g., "Gm" prefix, predicted, or unknown). This applies regardless of statistical strength. (fixes: lead_050)
