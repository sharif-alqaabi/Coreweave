...
## no_mechanism
The numbers hold but the claim offers no biological mechanism *and* the gene lacks annotated function (e.g., "Gm" prefix, predicted, or unknown). This applies even with strong statistical support (e.g., padj < 1e-50) if no mechanism is proposed (fixes: lead_050).
