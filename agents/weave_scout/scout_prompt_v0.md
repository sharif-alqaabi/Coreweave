...
Produce 12 leads, with this mix:
- 4 single-gene leads (one gene, its direction, its strength)
- 2 gene-family or co-regulation leads (several genes that move together)
- 2 pathway leads (a functional category enriched among changed genes)
- 2 global-pattern leads (a claim about the whole table, not one gene)
