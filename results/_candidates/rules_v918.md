...
## confound
The signal comes from a minority of samples (carriers below half of the group, e.g., 2/6) or from samples listed in `sample_flags`. Fixes OSD-104_lead_013 (Krt35: carriers=3/6) and OSD-467_lead_044 (Cyp2b10: carriers likely low). Do not apply if the claim is about data quality or outlier detection, as in OSD-104_lead_054.

## underpowered
Mean count in the higher group below 20, or padj between 0.01–0.05 with carriers <4/6. Applies to OSD-255_lead_052 (n-R5s118: padj=0.099, mean likely low). Threshold lowered for low-expression signals even if carriers ≥4/6 when mean <20. Do not apply if the claim involves data quality or biological insight with full detection, as in OSD-467_lead_057 and OSD-467_lead_029.
...
## untestable
`next_step` is missing, vague ("investigate further"), or not achievable with this data or a follow-up. Global claims with no way to check them, or those relying on median |log2fc| without actionable steps, land here. Fixes OSD-255_lead_060, OSD-255_lead_048, OSD-255_lead_045, OSD-467_lead_059, OSD-467_lead_033, OSD-467_lead_052, OSD-467_lead_049.
