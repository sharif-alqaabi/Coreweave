...
## underpowered
The effect rests on very low counts or a weak p-value. Threshold: mean count in the higher group below 20, or padj between 0.01 and 0.05 with carriers below 4/6. Applies to OSD-104_lead_022 (mean_count=7), OSD-255_lead_042 (mean_count=12), OSD-467_lead_045 (mean_count=15), OSD-467_lead_017 (mean_count=18), and others listed. Fixes: OSD-104_lead_022, OSD-255_lead_042, OSD-467_lead_045, OSD-467_lead_017.
...
## untestable
`next_step` is missing, vague, or not achievable with this data or a follow-up. Global claims (e.g., about medians or trends) without a specific test also land here. Applies to OSD-255_lead_060, OSD-255_lead_048, OSD-255_lead_045, OSD-467_lead_059, OSD-467_lead_033, OSD-467_lead_052. Fixes: OSD-255_lead_060, OSD-255_lead_048, OSD-255_lead_045, OSD-467_lead_059, OSD-467_lead_033, OSD-467_lead_052.
...
## examples
underpowered: Msx2 upregulated | mean count 7 in higher group
untestable: median |log2fc| 0.28 | no testable next step
ok: Cmc4 upregulated | present in all 8 flight samples
confound: Cyp2b10 downregulated | carriers 2/6, both flagged
contradicted: Glra3 increased | padj=0.98
ok: Meiosin expressed in controls | suggests germline contamination
untestable: Rps11-ps2 stable | no specific test proposed
ok: Kcnq5 upregulation | may alter membrane potential
